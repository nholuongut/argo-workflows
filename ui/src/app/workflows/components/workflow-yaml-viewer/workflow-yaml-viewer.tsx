        ...
        if (this.props.selectedNode) {
            ...
            if (parentNode) {
                contents.push(
                    <div key='parent-node'>
                        ...
                        <ObjectEditor type='io.nholuongut.workflow.v1alpha1.Template' value={getResolvedTemplates(this.props.workflow, parentNode)} />
                    </div>
                );
            }
            ...
            contents.push(
                <div key='current-node'>
                    ...
                    <ObjectEditor type='io.nholuongut.workflow.v1alpha1.Template' value={getResolvedTemplates(this.props.workflow, this.props.selectedNode)} />
                </div>
            );
        }
        ...
        if (templates && Object.keys(templates).length) {
            contents.push(
                <SlideContents
                    title='Templates'
                    key='templates'
                    contents={<ObjectEditor type='io.nholuongut.workflow.v1alpha1.Template' value={templates} />}
        ...
        if (storedTemplates && Object.keys(storedTemplates).length) {
            contents.push(
                <SlideContents
                    ...
                    contents={<ObjectEditor type='io.nholuongut.workflow.v1alpha1.Template' value={storedTemplates} />}
                    className='workflow-yaml-section'
                />
            );
        }

...
type Config struct {
	...
	// workflows.nholuongut.io/controller-instanceid, for the purposes of workflow segregation. This
	...
	// https://nholuongut.github.io/argo-workflows/workflow-executors/#emissary-emissary

...
import (
	...
	cmdutil "github.com/nholuongut/argo-workflows/v3/util/cmd"
	errorsutil "github.com/nholuongut/argo-workflows/v3/util/errors"
	"github.com/nholuongut/argo-workflows/v3/util/retry"
	unstructutil "github.com/nholuongut/argo-workflows/v3/util/unstructured"
...
// https://github.com/nholuongut/argo-workflows/issues/632
...
func SubmitWorkflow(ctx context.Context, wfIf v1alpha1.WorkflowInterface, wfClientset wfclientset.Interface, namespace string, wf *wfv1.Workflow, opts *wfv1.SubmitOpts) (*wfv1.Workflow, error) {
	...
	wftmplGetter := templateresolution.WrapWorkflowTemplateInterface(wfClientset.nholuongutV1alpha1().WorkflowTemplates(namespace))
	cwftmplGetter := templateresolution.WrapClusterWorkflowTemplateInterface(wfClientset.nholuongutV1alpha1().ClusterWorkflowTemplates())
...
func CreateServerDryRun(ctx context.Context, wf *wfv1.Workflow, wfClientset wfclientset.Interface) (*wfv1.Workflow, error) {
	...
	err := wfClientset.nholuongutV1alpha1().RESTClient().Post().

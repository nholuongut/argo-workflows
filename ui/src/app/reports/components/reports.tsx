...
const limit = 100;
const labelKeyPhase = 'workflows.nholuongut.io/phase';
const labelKeyWorkflowTemplate = 'workflows.nholuongut.io/workflow-template';
const labelKeyCronWorkflow = 'workflows.nholuongut.io/cron-workflow';
            ...
            return (
                <ZeroState title='Workflow Report'>
                    <p>
                        ...
                        <a href='https://nholuongut.github.io/argo-workflows/workflow-archive/'>workflow archive</a> to get long term data. Only the {limit} most recent workflows are
                        shown.
                    </p>
                    <p>Select a namespace and at least one label to get a report.</p>
                    <p>
                        <a href='https://nholuongut.github.io/argo-workflows/cost-optimisation/'>Learn more about cost optimization</a>
                    </p>
                </ZeroState>
            );
        }

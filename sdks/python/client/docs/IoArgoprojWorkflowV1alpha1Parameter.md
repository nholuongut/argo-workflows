...
**global_name** | **str** | GlobalName exports an output parameter to the global scope, making it available as &#39;{{io.nholuongut.workflow.v1alpha1.outputs.parameters.XXXX}} and in workflow.status.outputs.parameters | [optional] 
...
**value_from** | [**IonholuongutWorkflowV1alpha1ValueFrom**](IonholuongutWorkflowV1alpha1ValueFrom.md) |  | [optional] 

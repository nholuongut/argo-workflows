...
import (
	...
	"github.com/nholuongut/pkg/stats"
	...
	"github.com/nholuongut/argo-workflows/v3/server/apiserver"
	"github.com/nholuongut/argo-workflows/v3/server/auth"
	"github.com/nholuongut/argo-workflows/v3/server/types"
	"github.com/nholuongut/argo-workflows/v3/util/cmd"
	"github.com/nholuongut/argo-workflows/v3/util/help"
	pprofutil "github.com/nholuongut/argo-workflows/v3/util/pprof"
	tlsutils "github.com/nholuongut/argo-workflows/v3/util/tls"
)
...
See %s`, help.ArgoServer),
		RunE: func(c *cobra.Command, args []string) error {
			...
			if secure {
				...
				log.Warn("You are running in insecure mode. Learn how to enable transport layer security: https://nholuongut.github.io/argo-workflows/tls/")
			}
			...
			if reflect.DeepEqual(modes, auth.Modes{auth.Server: true}) {
				log.Warn("You are running without client authentication. Learn how to enable client authentication: https://nholuongut.github.io/argo-workflows/argo-server-auth-mode/")
			}

...
def lazy_import():
    ...
    globals()['IonholuongutWorkflowV1alpha1WorkflowEventBindingSpec'] = IonholuongutWorkflowV1alpha1WorkflowEventBindingSpec
    globals()['ObjectMeta'] = ObjectMeta


class IonholuongutWorkflowV1alpha1WorkflowEventBinding(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (IonholuongutWorkflowV1alpha1WorkflowEventBindingSpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, metadata, spec, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1WorkflowEventBinding - a model defined in OpenAPI

        Args:
            metadata (ObjectMeta):
            spec (IonholuongutWorkflowV1alpha1WorkflowEventBindingSpec):

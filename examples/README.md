...
Many of the Argo examples used in this walkthrough are available in the [`/examples` directory](https://github.com/nholuongut/argo-workflows/tree/master/examples) on GitHub. If you like this project, please give us a star!

For a complete description of the Argo workflow spec, please refer to [our spec definitions](https://github.com/nholuongut/argo-workflows/blob/master/pkg/apis/workflow/v1alpha1/workflow_types.go).
...
kubectl get po --selector=workflows.nholuongut.io/workflow=hello-world-xxx --show-all  # similar to argo
  ...
  - name: hardwired-artifact
    inputs:
      ...
      - name: argo-source
        path: /src
        git:
          repo: https://github.com/nholuongut/argo-workflows.git
          revision: "master"
...
A good example of a CI workflow spec is provided at https://github.com/nholuongut/argo-workflows/tree/master/examples/influxdb-ci.yaml. Because it just uses the concepts that we've already covered and is somewhat long, we don't go into details here.

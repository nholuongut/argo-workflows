...
import (
	...
	commonutil "github.com/nholuongut/argo-workflows/v3/util"
...
func (c *Controller) deleteWorkflow(ctx context.Context, key string) error {
	...
	err := c.wfclientset.nholuongutV1alpha1().Workflows(namespace).Delete(ctx, name, metav1.DeleteOptions{PropagationPolicy: commonutil.GetDeletePropagation()})
	if err != nil {

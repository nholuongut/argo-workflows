...
### [93c11a24ff](https://github.com/nholuongut/argo-workflows/commit/93c11a24ff06049c2197149acd787f702e5c1f9b) feat: Add TLS to Metrics and Telemetry servers (#7041)
...
### [0758eab11](https://github.com/nholuongut/argo-workflows/commit/0758eab11decb8a1e741abef3e0ec08c48a69ab8) feat(server)!: Sync dispatch of webhook events by default
...
### [bd49c6303](https://github.com/nholuongut/argo-workflows/commit/bd49c630328d30206a5c5b78cbc9a00700a28e7d) fix(artifact)!: default https to any URL missing a scheme. Fixes #6973
...
### [e5b131a33](https://github.com/nholuongut/argo-workflows/commit/e5b131a33) feat: Add template node to pod name. Fixes #1319 (#6712)
...
### [be63efe89](https://github.com/nholuongut/argo-workflows/commit/be63efe89) feat(executor)!: Change `argoexec` base image to alpine. Closes #5720 (#6006)
...
### [48d7ad3](https://github.com/nholuongut/argo-workflows/commit/48d7ad36c14e4a50c50332d6decd543a1b732b69) chore: Remove onExit naming transition scaffolding code (#6297)
...
### [ab361667a](https://github.com/nholuongut/argo-workflows/commit/ab361667a) feat(controller) Emissary executor.  (#4925)

The Emissary executor is not a breaking change per-se, but it is brand new so we would not recommend you use it by default yet. Instead, we recommend you test it out on some workflows using [config map configuration](https://github.com/nholuongut/argo-workflows/blob/master/docs/workflow-controller-configmap.yaml#L125).
...
### [be63efe89](https://github.com/nholuongut/argo-workflows/commit/e6fa41a) feat(controller): Expression template tags. Resolves #4548 & #1293 (#5115)
...
[Learn more](https://github.com/nholuongut/argo-workflows/issues/6314)

...
func kubeifySwagger(in, out string) {
	...
	definitions["io.nholuongut.workflow.v1alpha1.CronWorkflow"].(obj)["required"] = array{"metadata", "spec"}
	definitions["io.nholuongut.workflow.v1alpha1.Workflow"].(obj)["required"] = array{"metadata", "spec"}
	definitions["io.nholuongut.workflow.v1alpha1.ScriptTemplate"].(obj)["required"] = array{"image", "source"}

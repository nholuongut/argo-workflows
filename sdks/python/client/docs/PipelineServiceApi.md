...
# **get_pipeline**
> GithubComnholuongutLabsArgoDataflowApiV1alpha1Pipeline get_pipeline(namespace, name)
...
# **list_pipelines**
> GithubComnholuongutLabsArgoDataflowApiV1alpha1PipelineList list_pipelines(namespace)

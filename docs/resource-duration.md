...
The calculation is always an estimate, and is calculated by [duration.go](https://github.com/nholuongut/argo-workflows/blob/master/util/resource/duration.go) 

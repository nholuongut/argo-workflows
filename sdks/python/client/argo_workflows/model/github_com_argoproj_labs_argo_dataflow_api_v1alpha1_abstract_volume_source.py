...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1AbstractVolumeSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1AbstractVolumeSource - a model defined in OpenAPI

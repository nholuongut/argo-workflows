...
import (
	...
	"github.com/nholuongut/argo-workflows/v3/util/k8s"
)
...
var K8sRequestTotalMetric = prometheus.NewCounterVec(
	prometheus.CounterOpts{
		...
		Help:      "Number of kubernetes requests executed. https://nholuongut.github.io/argo-workflows/metrics/#argo_workflows_k8s_request_total",
	},

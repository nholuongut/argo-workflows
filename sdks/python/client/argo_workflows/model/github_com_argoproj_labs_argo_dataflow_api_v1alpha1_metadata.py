...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1Metadata(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1Metadata - a model defined in OpenAPI

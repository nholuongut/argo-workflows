...
func TestGetTemplateByName(t *testing.T) {
	...
	ctx := NewContextFromClientset(wfClientset.nholuongutV1alpha1().WorkflowTemplates(metav1.NamespaceDefault), wfClientset.nholuongutV1alpha1().ClusterWorkflowTemplates(), wftmpl, nil)
...
func TestWithTemplateHolder(t *testing.T) {
	...
	assert.EqualError(t, err, "workflowtemplates.nholuongut.io \"unknown-workflow-template\" not found")
}

...
def lazy_import():
    ...
    globals()['IonholuongutWorkflowV1alpha1WorkflowTemplateSpec'] = IonholuongutWorkflowV1alpha1WorkflowTemplateSpec
    globals()['ObjectMeta'] = ObjectMeta


class IonholuongutWorkflowV1alpha1ClusterWorkflowTemplate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': (IonholuongutWorkflowV1alpha1WorkflowTemplateSpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, metadata, spec, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1ClusterWorkflowTemplate - a model defined in OpenAPI

        Args:
            metadata (ObjectMeta):
            spec (IonholuongutWorkflowV1alpha1WorkflowTemplateSpec):

...
> IonholuongutEventsV1alpha1Sensor sensorServiceCreateSensor(namespace, body)
...
import io.nholuongut.workflow.apis.SensorServiceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IonholuongutEventsV1alpha1Sensor result = apiInstance.sensorServiceCreateSensor(namespace, body);
...
> IonholuongutEventsV1alpha1Sensor sensorServiceGetSensor(namespace, name, getOptionsResourceVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IonholuongutEventsV1alpha1Sensor result = apiInstance.sensorServiceGetSensor(namespace, name, getOptionsResourceVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
> IonholuongutEventsV1alpha1SensorList sensorServiceListSensors(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
> IonholuongutEventsV1alpha1Sensor sensorServiceUpdateSensor(namespace, name, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IonholuongutEventsV1alpha1Sensor result = apiInstance.sensorServiceUpdateSensor(namespace, name, body);
      System.out.println(result);
    } catch (ApiException e) {

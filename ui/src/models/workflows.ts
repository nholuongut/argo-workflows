...
export const labels = {
    clusterWorkflowTemplate: 'workflows.nholuongut.io/cluster-workflow-template',
    completed: 'workflows.nholuongut.io/completed',
    creator: 'workflows.nholuongut.io/creator',
    cronWorkflow: 'workflows.nholuongut.io/cron-workflow',
    workflowTemplate: 'workflows.nholuongut.io/workflow-template'
};

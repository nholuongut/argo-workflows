...
var stepsOnExitTmpl = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: steps-on-exit
spec:
...
var dagOnExitTmpl = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: dag-on-exit
spec:
...
var dagOnExitTmplWithArt = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: dag-on-exit
spec:
...
var testWorkflowOnExitHttpReconciliation = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
func TestWorkflowOnExitHttpReconciliation(t *testing.T) {
	...
	taskSets, err := woc.controller.wfclientset.nholuongutV1alpha1().WorkflowTaskSets("").List(ctx, v1.ListOptions{})

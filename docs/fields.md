...
- [`archive-location.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/archive-location.yaml)

- [`arguments-artifacts.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/arguments-artifacts.yaml)

- [`arguments-parameters-from-configmap.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/arguments-parameters-from-configmap.yaml)

- [`arguments-parameters.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/arguments-parameters.yaml)

- [`artifact-disable-archive.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifact-disable-archive.yaml)

- [`artifact-passing-subpath.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifact-passing-subpath.yaml)

- [`artifact-passing.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifact-passing.yaml)

- [`artifact-path-placeholders.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifact-path-placeholders.yaml)

- [`artifact-repository-ref.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifact-repository-ref.yaml)

- [`artifactory-artifact.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/artifactory-artifact.yaml)

- [`ci-output-artifact.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/ci-output-artifact.yaml)

- [`ci.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/ci.yaml)

- [`cluster-wftmpl-dag.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cluster-workflow-template/cluster-wftmpl-dag.yaml)

- [`mixed-cluster-namespaced-wftmpl-steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cluster-workflow-template/mixed-cluster-namespaced-wftmpl-steps.yaml)

- [`workflow-template-ref-with-entrypoint-arg-passing.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cluster-workflow-template/workflow-template-ref-with-entrypoint-arg-passing.yaml)

- [`workflow-template-ref.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cluster-workflow-template/workflow-template-ref.yaml)

- [`coinflip-recursive.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/coinflip-recursive.yaml)

- [`coinflip.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/coinflip.yaml)

- [`colored-logs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/colored-logs.yaml)

- [`conditional-artifacts.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/conditional-artifacts.yaml)

- [`conditional-parameters.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/conditional-parameters.yaml)

- [`conditionals-complex.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/conditionals-complex.yaml)

- [`conditionals.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/conditionals.yaml)

- [`graph-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/container-set-template/graph-workflow.yaml)

- [`outputs-result-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/container-set-template/outputs-result-workflow.yaml)

- [`parallel-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/container-set-template/parallel-workflow.yaml)

- [`sequence-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/container-set-template/sequence-workflow.yaml)

- [`workspace-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/container-set-template/workspace-workflow.yaml)

- [`continue-on-fail.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/continue-on-fail.yaml)

- [`cron-backfill.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cron-backfill.yaml)

- [`custom-metrics.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/custom-metrics.yaml)

- [`daemon-nginx.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/daemon-nginx.yaml)

- [`daemon-step.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/daemon-step.yaml)

- [`daemoned-stateful-set-with-service.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/daemoned-stateful-set-with-service.yaml)

- [`dag-coinflip.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-coinflip.yaml)

- [`dag-conditional-artifacts.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-conditional-artifacts.yaml)

- [`dag-conditional-parameters.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-conditional-parameters.yaml)

- [`dag-continue-on-fail.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-continue-on-fail.yaml)

- [`dag-custom-metrics.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-custom-metrics.yaml)

- [`dag-daemon-task.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-daemon-task.yaml)

- [`dag-diamond-steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-diamond-steps.yaml)

- [`dag-diamond.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-diamond.yaml)

- [`dag-disable-failFast.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-disable-failFast.yaml)

- [`dag-enhanced-depends.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-enhanced-depends.yaml)

- [`dag-inline-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-inline-workflow.yaml)

- [`dag-multiroot.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-multiroot.yaml)

- [`dag-nested.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-nested.yaml)

- [`dag-targets.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-targets.yaml)

- [`dag-task-level-timeout.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-task-level-timeout.yaml)

- [`data-transformations.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/data-transformations.yaml)

- [`default-pdb-support.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/default-pdb-support.yaml)

- [`dns-config.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dns-config.yaml)

- [`exit-code-output-variable.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-code-output-variable.yaml)

- [`exit-handler-dag-level.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handler-dag-level.yaml)

- [`exit-handler-slack.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handler-slack.yaml)

- [`exit-handler-step-level.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handler-step-level.yaml)

- [`exit-handler-with-artifacts.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handler-with-artifacts.yaml)

- [`exit-handler-with-param.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handler-with-param.yaml)

- [`exit-handlers.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/exit-handlers.yaml)

- [`expression-destructure-json.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/expression-destructure-json.yaml)

- [`expression-reusing-verbose-snippets.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/expression-reusing-verbose-snippets.yaml)

- [`expression-tag-template-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/expression-tag-template-workflow.yaml)

- [`fibonacci-seq-conditional-param.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/fibonacci-seq-conditional-param.yaml)

- [`forever.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/forever.yaml)

- [`fun-with-gifs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/fun-with-gifs.yaml)

- [`gc-ttl.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/gc-ttl.yaml)

- [`global-outputs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/global-outputs.yaml)

- [`global-parameters-from-configmap-referenced-as-local-variable.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/global-parameters-from-configmap-referenced-as-local-variable.yaml)

- [`global-parameters-from-configmap.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/global-parameters-from-configmap.yaml)

- [`global-parameters.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/global-parameters.yaml)

- [`handle-large-output-results.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/handle-large-output-results.yaml)

- [`hdfs-artifact.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/hdfs-artifact.yaml)

- [`hello-hybrid.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/hello-hybrid.yaml)

- [`hello-windows.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/hello-windows.yaml)

- [`hello-world.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/hello-world.yaml)

- [`http-hello-world.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/http-hello-world.yaml)

- [`http-success-condition.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/http-success-condition.yaml)

- [`image-pull-secrets.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/image-pull-secrets.yaml)

- [`influxdb-ci.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/influxdb-ci.yaml)

- [`init-container.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/init-container.yaml)

- [`input-artifact-gcs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-gcs.yaml)

- [`input-artifact-git.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-git.yaml)

- [`input-artifact-http.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-http.yaml)

- [`input-artifact-oss.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-oss.yaml)

- [`input-artifact-raw.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-raw.yaml)

- [`input-artifact-s3.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/input-artifact-s3.yaml)

- [`k8s-jobs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-jobs.yaml)

- [`k8s-json-patch-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-json-patch-workflow.yaml)

- [`k8s-orchestration.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-orchestration.yaml)

- [`k8s-owner-reference.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-owner-reference.yaml)

- [`k8s-patch-basic.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-patch-basic.yaml)

- [`k8s-patch.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-patch.yaml)

- [`k8s-resource-log-selector.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-resource-log-selector.yaml)

- [`k8s-set-owner-reference.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-set-owner-reference.yaml)

- [`k8s-wait-wf.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/k8s-wait-wf.yaml)

- [`key-only-artifact.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/key-only-artifact.yaml)

- [`loops-dag.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops-dag.yaml)

- [`loops-maps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops-maps.yaml)

- [`loops-param-argument.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops-param-argument.yaml)

- [`loops-param-result.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops-param-result.yaml)

- [`loops-sequence.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops-sequence.yaml)

- [`loops.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/loops.yaml)

- [`map-reduce.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/map-reduce.yaml)

- [`nested-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/nested-workflow.yaml)

- [`node-selector.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/node-selector.yaml)

- [`output-artifact-gcs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/output-artifact-gcs.yaml)

- [`output-artifact-s3.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/output-artifact-s3.yaml)

- [`output-parameter.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/output-parameter.yaml)

- [`parallelism-limit.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parallelism-limit.yaml)

- [`parallelism-nested-dag.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parallelism-nested-dag.yaml)

- [`parallelism-nested-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parallelism-nested-workflow.yaml)

- [`parallelism-nested.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parallelism-nested.yaml)

- [`parallelism-template-limit.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parallelism-template-limit.yaml)

- [`parameter-aggregation-dag.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parameter-aggregation-dag.yaml)

- [`parameter-aggregation-script.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parameter-aggregation-script.yaml)

- [`parameter-aggregation.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/parameter-aggregation.yaml)

- [`pod-gc-strategy-with-label-selector.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-gc-strategy-with-label-selector.yaml)

- [`pod-gc-strategy.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-gc-strategy.yaml)

- [`pod-metadata-wf-field.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-metadata-wf-field.yaml)

- [`pod-metadata.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-metadata.yaml)

- [`pod-spec-from-previous-step.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-spec-from-previous-step.yaml)

- [`pod-spec-patch-wf-tmpl.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-spec-patch-wf-tmpl.yaml)

- [`pod-spec-patch.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-spec-patch.yaml)

- [`pod-spec-yaml-patch.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/pod-spec-yaml-patch.yaml)

- [`recursive-for-loop.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/recursive-for-loop.yaml)

- [`resource-delete-with-flags.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/resource-delete-with-flags.yaml)

- [`resource-flags.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/resource-flags.yaml)

- [`resubmit.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/resubmit.yaml)

- [`retry-backoff.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-backoff.yaml)

- [`retry-conditional.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-conditional.yaml)

- [`retry-container-to-completion.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-container-to-completion.yaml)

- [`retry-container.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-container.yaml)

- [`retry-on-error.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-on-error.yaml)

- [`retry-script.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-script.yaml)

- [`retry-with-steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/retry-with-steps.yaml)

- [`scripts-bash.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/scripts-bash.yaml)

- [`scripts-javascript.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/scripts-javascript.yaml)

- [`scripts-python.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/scripts-python.yaml)

- [`secrets.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/secrets.yaml)

- [`selected-executor-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/selected-executor-workflow.yaml)

- [`sidecar-dind.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/sidecar-dind.yaml)

- [`sidecar-nginx.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/sidecar-nginx.yaml)

- [`sidecar.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/sidecar.yaml)

- [`status-reference.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/status-reference.yaml)

- [`step-level-timeout.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/step-level-timeout.yaml)

- [`steps-inline-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/steps-inline-workflow.yaml)

- [`steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/steps.yaml)

- [`suspend-template-outputs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/suspend-template-outputs.yaml)

- [`suspend-template.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/suspend-template.yaml)

- [`synchronization-mutex-tmpl-level.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-mutex-tmpl-level.yaml)

- [`synchronization-mutex-wf-level.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-mutex-wf-level.yaml)

- [`template-defaults.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/template-defaults.yaml)

- [`template-on-exit.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/template-on-exit.yaml)

- [`timeouts-step.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/timeouts-step.yaml)

- [`timeouts-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/timeouts-workflow.yaml)

- [`volumes-emptydir.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/volumes-emptydir.yaml)

- [`volumes-existing.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/volumes-existing.yaml)

- [`volumes-pvc.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/volumes-pvc.yaml)

- [`work-avoidance.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/work-avoidance.yaml)

- [`workflow-of-workflows.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-of-workflows.yaml)

- [`dag.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/dag.yaml)

- [`hello-world.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/hello-world.yaml)

- [`retry-with-steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/retry-with-steps.yaml)

- [`steps.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/steps.yaml)

- [`workflow-archive-logs.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/workflow-archive-logs.yaml)

- [`workflow-template-ref-with-entrypoint-arg-passing.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/workflow-template-ref-with-entrypoint-arg-passing.yaml)

- [`workflow-template-ref.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/workflow-template-ref.yaml)
</details>
...
- [`cron-workflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cron-workflow.yaml)

- [`dag-inline-cronworkflow.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-inline-cronworkflow.yaml)
</details>
...
- [`buildkit-template.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/buildkit-template.yaml)

- [`cron-backfill.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cron-backfill.yaml)

- [`dag-inline-workflowtemplate.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-inline-workflowtemplate.yaml)

- [`event-consumer-workflowtemplate.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-event-binding/event-consumer-workflowtemplate.yaml)

- [`templates.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/workflow-template/templates.yaml)
</details>
...
- [`clustertemplates.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/cluster-workflow-template/clustertemplates.yaml)
...
- [`dag-inline-clusterworkflowtemplate.yaml`](https://github.com/nholuongut/argo-workflows/blob/master/examples/dag-inline-clusterworkflowtemplate.yaml)
...
| Field Name | Field Type | Description   |
|:----------:|:----------:|---------------|
|`activeDeadlineSeconds`|`integer`|Optional duration in seconds relative to the workflow start time which the workflow is allowed to run before the controller terminates the io.nholuongut.workflow.v1alpha1. A value of zero is used to terminate a Running workflow|
|`affinity`|[`Affinity`](#affinity)|Affinity sets the scheduling constraints for all pods in the io.nholuongut.workflow.v1alpha1. Can be overridden by an affinity specified in the template|
|`archiveLogs`|`boolean`|ArchiveLogs indicates if the container logs should be archived|
|`arguments`|[`Arguments`](#arguments)|Arguments contain the parameters and artifacts sent to the workflow entrypoint Parameters are referencable globally using the 'workflow' variable prefix. e.g. {{io.nholuongut.workflow.v1alpha1.parameters.myparam}}|
...
|`entrypoint`|`string`|Entrypoint is a template reference to the starting point of the io.nholuongut.workflow.v1alpha1.|
|`executor`|[`ExecutorConfig`](#executorconfig)|Executor holds configurations of executor containers of the io.nholuongut.workflow.v1alpha1.|
...
|`key`|`string`|The config map key. Defaults to the value of the "workflows.nholuongut.io/default-artifact-repository" annotation.|
...
|`globalName`|`string`|GlobalName exports an output artifact to the global scope, making it available as '{{io.nholuongut.workflow.v1alpha1.outputs.artifacts.XXXX}} and in workflow.status.outputs.artifacts|
...
|`globalName`|`string`|GlobalName exports an output parameter to the global scope, making it available as '{{io.nholuongut.workflow.v1alpha1.outputs.parameters.XXXX}} and in workflow.status.outputs.parameters|
...
| Field Name | Field Type | Description   |
|:----------:|:----------:|---------------|
|`failFast`|`boolean`|This flag is for DAG logic. The DAG logic has a built-in "fail fast" feature to stop scheduling new steps, as soon as it detects that one of the DAG nodes is failed. Then it waits until all DAG nodes are completed before failing the DAG itself. The FailFast flag default is true,  if set to false, it will allow a DAG to run all branches of the DAG to completion (either success or failure), regardless of the failed outcomes of branches in the DAG. More info and example about this feature at https://github.com/nholuongut/argo-workflows/issues/1442|
...
| Field Name | Field Type | Description   |
|:----------:|:----------:|---------------|
|`holding`|`Array<`[`MutexHolding`](#mutexholding)`>`|Holding is a list of mutexes and their respective objects that are held by mutex lock for this io.nholuongut.workflow.v1alpha1.|
...
| Field Name | Field Type | Description   |
|:----------:|:----------:|---------------|
|`holders`|`Array< string >`|Holders stores the list of current holder names in the io.nholuongut.workflow.v1alpha1.|

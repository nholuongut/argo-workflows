...
func TestGitArtifactDriverLoad_HTTPS(t *testing.T) {
	for _, tt := range []struct {
		...
		{"https://github.com/nholuongut/empty.git"},
	} {
...
func TestGitArtifactDriverLoad_SSL(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{"Insecure", true, "https://github.com/nholuongut/argo-workflows.git"},
		{"Secure", false, "https://github.com/nholuongut/argo-workflows.git"},
		{"Insecure", true, "https://github.com/nholuongut/empty.git"},
		{"Secure", false, "https://github.com/nholuongut/empty.git"},
	} {
...
func TestGetUser(t *testing.T) {
	for _, tt := range []struct {
		...
		{"Username in SSH url", "gitaly@github.com:nholuongut/argo-workflows.git", "gitaly"},
		{"Default username", "https://github.com/nholuongut/argo-workflows.git", "git"},
	} {
		t.Run(tt.name, func(t *testing.T) {

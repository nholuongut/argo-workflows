...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1STANAuth(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1STANAuth - a model defined in OpenAPI

...
metadata:
  namespace: my-ns
  labels:
    workflows.nholuongut.io/workflow: my-wf
`, obj)
...
metadata:
  ...
  labels:
    workflows.nholuongut.io/workflow: my-wf
  annotations:
    workflows.nholuongut.io/node-id: retry-test-p7jzr-2308805457
    workflows.nholuongut.io/node-name: 'retry-test-p7jzr[0].steps-outer-step1'
`
	withoutNodeID := `
apiVersion: v1
kind: Pod

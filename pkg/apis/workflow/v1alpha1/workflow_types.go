...
type ArtifactRepositoryRef struct {
	...
	// The config map key. Defaults to the value of the "workflows.nholuongut.io/default-artifact-repository" annotation.
...
type DAGTemplate struct {
	...
	// More info and example about this feature at https://github.com/nholuongut/argo-workflows/issues/1442

...
class IonholuongutWorkflowV1alpha1CronWorkflowSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'workflow_spec': (IonholuongutWorkflowV1alpha1WorkflowSpec,),  # noqa: E501
    ...
    def _from_openapi_data(cls, schedule, workflow_spec, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1CronWorkflowSpec - a model defined in OpenAPI

        Args:
            schedule (str): Schedule is a schedule to run the Workflow in Cron format
            workflow_spec (IonholuongutWorkflowV1alpha1WorkflowSpec):

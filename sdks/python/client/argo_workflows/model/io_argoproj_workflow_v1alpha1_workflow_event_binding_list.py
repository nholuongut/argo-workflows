...
def lazy_import():
    ...
    globals()['IonholuongutWorkflowV1alpha1WorkflowEventBinding'] = IonholuongutWorkflowV1alpha1WorkflowEventBinding
    globals()['ListMeta'] = ListMeta


class IonholuongutWorkflowV1alpha1WorkflowEventBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([IonholuongutWorkflowV1alpha1WorkflowEventBinding],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, metadata, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1WorkflowEventBindingList - a model defined in OpenAPI

        Args:
            items ([IonholuongutWorkflowV1alpha1WorkflowEventBinding]):
            metadata (ListMeta):

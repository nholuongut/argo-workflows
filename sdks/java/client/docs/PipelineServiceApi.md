...
import io.nholuongut.workflow.apis.PipelineServiceApi;
...
> GithubComnholuongutLabsArgoDataflowApiV1alpha1Pipeline pipelineServiceGetPipeline(namespace, name, getOptionsResourceVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GithubComnholuongutLabsArgoDataflowApiV1alpha1Pipeline result = apiInstance.pipelineServiceGetPipeline(namespace, name, getOptionsResourceVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
[**GithubComnholuongutLabsArgoDataflowApiV1alpha1Pipeline**](GithubComnholuongutLabsArgoDataflowApiV1alpha1Pipeline.md)
...
> GithubComnholuongutLabsArgoDataflowApiV1alpha1PipelineList pipelineServiceListPipelines(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
[**GithubComnholuongutLabsArgoDataflowApiV1alpha1PipelineList**](GithubComnholuongutLabsArgoDataflowApiV1alpha1PipelineList.md)

...
class IonholuongutWorkflowV1alpha1WorkflowList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([IonholuongutWorkflowV1alpha1Workflow],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, metadata, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1WorkflowList - a model defined in OpenAPI

        Args:
            items ([IonholuongutWorkflowV1alpha1Workflow]):
            metadata (ListMeta):

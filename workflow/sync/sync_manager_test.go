...
metadata:
  ...
  selfLink: /apis/nholuongut.io/v1alpha1/namespaces/default/workflows/hello-world-prtl9
...
func TestSemaphoreWfLevel(t *testing.T) {
	...
	t.Run("InitializeSynchronization", func(t *testing.T) {
		...
		wfList, err := wfclientset.nholuongutV1alpha1().Workflows("default").List(ctx, metav1.ListOptions{})
		assert.NoError(t, err)

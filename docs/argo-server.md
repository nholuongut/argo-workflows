...
Hosted mode is provided as part of the standard [manifests](https://github.com/nholuongut/argo-workflows/blob/master/manifests), [specifically in argo-server-deployment.yaml](https://github.com/nholuongut/argo-workflows/blob/master/manifests/base/argo-server/argo-server-deployment.yaml) .
...
[Learn more](https://github.com/nholuongut/argo-workflows/issues/3080)

...
class IonholuongutWorkflowV1alpha1CronWorkflowStatus(ModelNormal):
    ...
    def _from_openapi_data(cls, active, conditions, last_scheduled_time, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1CronWorkflowStatus - a model defined in OpenAPI

        Args:
            active ([ObjectReference]): Active is a list of active workflows stemming from this CronWorkflow
            conditions ([IonholuongutWorkflowV1alpha1Condition]): Conditions is a list of conditions the CronWorkflow may have

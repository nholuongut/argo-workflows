...
class IonholuongutWorkflowV1alpha1ArtifactoryArtifactRepository(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1ArtifactoryArtifactRepository - a model defined in OpenAPI

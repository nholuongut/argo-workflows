...
export const EventFlowPage = ({history, location, match}: RouteComponentProps<any>) => {
    ...
    useEffect(() => {
        ...
        const listWatch = new ListWatch<Workflow>(
            () =>
                services.workflows.list(namespace, null, ['events.nholuongut.io/sensor', 'events.nholuongut.io/trigger'], null, [
                    'metadata',
                    'items.metadata.name',
            ...
            resourceVersion =>
                services.workflows.watch({
                    namespace,
                    resourceVersion,
                    labels: ['events.nholuongut.io/sensor', 'events.nholuongut.io/trigger']
                }),
            () => setError(null),
            () => setError(null),
            (items, item, type) => {
        ...
        <Page
            ...
            {emptyGraph ? (
                <ZeroState>
                    ...
                    <p>
                        <a href='https://nholuongut.github.io/argo-events/'>Learn more</a>
                    </p>
                </ZeroState>
            ) : (
                <>

...
def lazy_import():
    ...
    globals()['IonholuongutWorkflowV1alpha1HTTPHeader'] = IonholuongutWorkflowV1alpha1HTTPHeader


class IonholuongutWorkflowV1alpha1HTTP(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'url': (str,),  # noqa: E501
            'body': (str,),  # noqa: E501
            'headers': ([IonholuongutWorkflowV1alpha1HTTPHeader],),  # noqa: E501
    ...
    def _from_openapi_data(cls, url, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1HTTP - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            headers ([IonholuongutWorkflowV1alpha1HTTPHeader]): Headers are an optional list of headers to send with HTTP requests. [optional]  # noqa: E501

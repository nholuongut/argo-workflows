...
const (
	validWf = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
spec:
  ...
  - name: echo
    container:
      ...
      args: ["hello world"]
`
	invalidWf = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: test-custom-enforcer
spec:
...
func TestGetTemplateHolderString(t *testing.T) {
	assert.Equal(t, "*v1alpha1.DAGTask invalid (https://nholuongut.github.io/argo-workflows/templates/)", GetTemplateHolderString(&wfv1.DAGTask{}))

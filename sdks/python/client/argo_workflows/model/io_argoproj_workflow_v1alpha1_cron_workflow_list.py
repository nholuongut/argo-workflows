...
class IonholuongutWorkflowV1alpha1CronWorkflowList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([IonholuongutWorkflowV1alpha1CronWorkflow],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, metadata, *args, **kwargs):  # noqa: E501
        """IonholuongutWorkflowV1alpha1CronWorkflowList - a model defined in OpenAPI

        Args:
            items ([IonholuongutWorkflowV1alpha1CronWorkflow]):
            metadata (ListMeta):

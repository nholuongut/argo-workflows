...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1HTTPHeaderSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1HTTPHeaderSource - a model defined in OpenAPI

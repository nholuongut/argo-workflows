...
import (
	...
	"github.com/nholuongut/pkg/strftime"
	...
	intstrutil "github.com/nholuongut/argo-workflows/v3/util/intstr"
	"github.com/nholuongut/argo-workflows/v3/util/template"
	"github.com/nholuongut/argo-workflows/v3/workflow/common"
	"github.com/nholuongut/argo-workflows/v3/workflow/controller/cache"
	hydratorfake "github.com/nholuongut/argo-workflows/v3/workflow/hydrator/fake"
	"github.com/nholuongut/argo-workflows/v3/workflow/sync"
...
func TestOperateWorkflowPanicRecover(t *testing.T) {
	...
	_, err := controller.wfclientset.nholuongutV1alpha1().Workflows("").Create(ctx, wf, metav1.CreateOptions{})
...
func Test_wfOperationCtx_reapplyUpdate(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		updatedWf, err := woc.reapplyUpdate(ctx, controller.wfclientset.nholuongutV1alpha1().Workflows(""), nodes)
	...
	t.Run("ErrUpdatingCompletedWorkflow", func(t *testing.T) {
		...
		defer cancel()
		woc := newWorkflowOperationCtx(wf, controller)
		_, err := woc.reapplyUpdate(ctx, controller.wfclientset.nholuongutV1alpha1().Workflows(""), wfv1.Nodes{})
	...
	t.Run("ErrUpdatingCompletedNode", func(t *testing.T) {
		...
		defer cancel()
		woc := newWorkflowOperationCtx(wf, controller)
		_, err := woc.reapplyUpdate(ctx, controller.wfclientset.nholuongutV1alpha1().Workflows(""), wf.Status.Nodes)
...
metadata:
  ...
  namespace: my-ns
  labels:
    workflows.nholuongut.io/workflow-template: my-wftmpl
spec:
  entrypoint: main
  templates:
   - name: main
...
func TestGlobalParams(t *testing.T) {
	...
	woc.operate(ctx)
	assert.Contains(t, woc.globalParams, "workflow.labels.workflows.nholuongut.io/phase")
}
...
func TestVolumeGCStrategy(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := context.Background()
			wfcset := controller.wfclientset.nholuongutV1alpha1().Workflows("")
			woc := newWorkflowOperationCtx(wf, controller)
			woc.operate(ctx)
...
metadata:
  ...
  labels:
    ...
    workflows.nholuongut.io/phase: Failed
  name: retry-backoff-s69z6
  namespace: argo
  resourceVersion: "348670"
  selfLink: /apis/nholuongut.io/v1alpha1/namespaces/argo/workflows/retry-backoff-s69z6
...
func TestParamSubstitutionWithArtifact(t *testing.T) {
	...
	ctx := context.Background()
	woc.operate(ctx)
	wf, err := woc.controller.wfclientset.nholuongutV1alpha1().Workflows("").Get(ctx, wf.ObjectMeta.Name, metav1.GetOptions{})
	assert.NoError(t, err)
...
metadata:
  ...
  labels:
    image: foo:bar
  annotations:
    k8s-webhook-handler.io/repo: "git@github.com:nholuongut/argo.git"
...
func TestMetadataPassing(t *testing.T) {
	...
	for _, ev := range container.Env {
		switch ev.Name {
		case "REPO":
			assert.Equal(t, "git@github.com:nholuongut/argo.git", ev.Value)
			foundRepo = true
		case "REVISION":
...
metadata:
  ...
  generation: 4
  labels:
    workflows.nholuongut.io/phase: Running
  name: echo-wngc4
  namespace: argo
  resourceVersion: "6339"
  selfLink: /apis/nholuongut.io/v1alpha1/namespaces/argo/workflows/echo-wngc4
...
func TestConfigMapCacheLoadOperate(t *testing.T) {
	...
	ctx := context.Background()
	_, err := controller.wfclientset.nholuongutV1alpha1().Workflows(wf.ObjectMeta.Namespace).Create(ctx, wf, metav1.CreateOptions{})
	assert.NoError(t, err)
...
func TestResubmitMemoization(t *testing.T) {
	wf := wfv1.MustUnmarshalWorkflow(`apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: my-wf
spec:
...
status:
  ...
  - containerID: docker://d31f0d56f29b6962ef1493b2df6b7cdb54d48d8b8fa95d7e9c98ddc56f857b35
    image: nholuongut/argoexec:v2.9.5
    imageID: docker-pullable://nholuongut/argoexec@sha256:989114232892e051c25be323af626149452578d3ebbdc3e9ec7205bba3918d48
    lastState:
      waiting: {}
    name: wait
    ready: false
...
status:
  ...
  - containerID: containerd://765e8084b1c416d412c8072dca624cab886aae3858d1196b5aaceb7a775ce372
    image: docker.io/nholuongut/argosay:v2
    imageID: docker.io/nholuongut/argosay@sha256:3d2d553a462cfe3288833a010c1d91454bd05a0e02937f2f82050d68ca57a580
    lastState: {}
    name: main
    ready: false
    restartCount: 0
  ...
  - containerID: containerd://12b93c7a73c7448a3034e63181ca9c8db8dbaf1d7d43dd5ad90c20814a757b51
    image: docker.io/nholuongut/argoexec:latest
...
metadata:
  name: hello-world
  annotations:
    workflows.nholuongut.io/scheduled-time: 2006-01-02T15:04:05-07:00
spec:
  entrypoint: whalesay
  shutdown: "Stop"
  templates:
...
const rootRetryStrategyCompletes = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
var wfPendingWithSync = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
var wfGlopalArtifactNil = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
const testDagTwoChildrenWithNonExpectedNodeType = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
const testDagTwoChildrenContainerSet = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
func TestGetContainerRuntimeExecutor(t *testing.T) {
	...
	t.Run("Labels", func(t *testing.T) {
		executor := controller.GetContainerRuntimeExecutor(labels.Set{"workflows.nholuongut.io/container-runtime-executor": "emissary"})
		assert.Equal(t, common.ContainerRuntimeExecutorEmissary, executor)
	})
}
...
metadata:
  ...
  annotations:
    ...
    workflows.nholuongut.io/pod-name-format: v1
  managedFields:
    ...
    - manager: workflow-controller
      ...
      fieldsV1:
        'f:metadata':
          'f:annotations':
            'f:workflows.nholuongut.io/pod-name-format': {}
          'f:labels':
            'f:workflows.nholuongut.io/completed': {}
            'f:workflows.nholuongut.io/phase': {}
        'f:spec': {}
        'f:status': {}
spec:
  templates:

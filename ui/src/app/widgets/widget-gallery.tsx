...
export const WidgetGallery = ({namespace, name, label}: {namespace: string; name?: string; label?: string}) => (
    <div className='white-box'>
        <h3>Widgets</h3>
        <p>
            These widgets can be embedded inside other applications. <a href='https://nholuongut.github.io/argo-workflows/widgets'>Learn more</a>
        </p>
        {[
            {
                title: 'Status Badge',
        ...
        <p>
            Widgets not loading? Check for <a href='https://nholuongut.github.io/argo-workflows/widgets'>solutions in the docs</a>.
        </p>
    </div>
);

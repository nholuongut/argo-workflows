...
Examples:
1. [Workflow level semaphore](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-wf-level.yaml)
1. [Workflow level mutex](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-mutex-wf-level.yaml)
1. [Step level semaphore](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-tmpl-level.yaml)
1. [Step level mutex](https://github.com/nholuongut/argo-workflows/blob/master/examples/synchronization-mutex-tmpl-level.yaml)

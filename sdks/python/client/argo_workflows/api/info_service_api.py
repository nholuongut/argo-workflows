...
class InfoServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_info = _Endpoint(
            settings={
                'response_type': (IonholuongutWorkflowV1alpha1InfoResponse,),
                'auth': [],
        ...
        self.get_user_info = _Endpoint(
            settings={
                'response_type': (IonholuongutWorkflowV1alpha1GetUserInfoResponse,),
                'auth': [],
        ...
        self.get_version = _Endpoint(
            settings={
                'response_type': (IonholuongutWorkflowV1alpha1Version,),
                'auth': [],

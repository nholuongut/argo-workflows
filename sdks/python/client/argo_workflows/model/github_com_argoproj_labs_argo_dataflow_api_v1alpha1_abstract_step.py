...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1AbstractStep(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1AbstractStep - a model defined in OpenAPI

...
import (
	...
	"github.com/nholuongut/argo-workflows/v3/persist/sqldb/mocks"
	...
	v1alpha "github.com/nholuongut/argo-workflows/v3/pkg/client/clientset/versioned/fake"
...
const wf1 = `
{
    ...
    "metadata": {
        ...
        "generation": 5,
        "labels": {
            "workflows.nholuongut.io/controller-instanceid": "my-instanceid",
        ...
        "selfLink": "/apis/nholuongut.io/v1alpha1/namespaces/workflows/workflows/hello-world-9tql2",
...
const wf2 = `
{
    ...
    "metadata": {
        ...
        "selfLink": "/apis/nholuongut.io/v1alpha1/namespaces/workflows/workflows/hello-world-b6h5m",

...
It is only possible to submit workflow templates your access token has access to: [example role](https://raw.githubusercontent.com/nholuongut/argo-workflows/master/manifests/quick-start/base/webhooks/submit-workflow-template-role.yaml).
...
```
payload.repository.clone_url == "http://gihub.com/nholuongut/argo"
```

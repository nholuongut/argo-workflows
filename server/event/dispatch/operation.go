...
import (
	...
	"github.com/nholuongut/argo-workflows/v3/util/expr/argoexpr"
	exprenv "github.com/nholuongut/argo-workflows/v3/util/expr/env"
	"github.com/nholuongut/argo-workflows/v3/util/instanceid"
	jsonutil "github.com/nholuongut/argo-workflows/v3/util/json"
	"github.com/nholuongut/argo-workflows/v3/util/labels"
...
func (o *Operation) dispatch(ctx context.Context, wfeb wfv1.WorkflowEventBinding) (*wfv1.Workflow, error) {
	...
	if matched && submit != nil {
		...
		var err error
		if ref.ClusterScope {
			tmpl, err = client.nholuongutV1alpha1().ClusterWorkflowTemplates().Get(ctx, ref.Name, metav1.GetOptions{})
		} else {
			tmpl, err = client.nholuongutV1alpha1().WorkflowTemplates(wfeb.Namespace).Get(ctx, ref.Name, metav1.GetOptions{})
		}
		if err != nil {
		...
		wf, err = client.nholuongutV1alpha1().Workflows(wfeb.Namespace).Create(ctx, wf, metav1.CreateOptions{})
		if err != nil {

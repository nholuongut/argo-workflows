...
var (
	...
	wftmplGetter  = templateresolution.WrapWorkflowTemplateInterface(wfClientset.nholuongutV1alpha1().WorkflowTemplates(metav1.NamespaceDefault))
...
func createWorkflowTemplate(yamlStr string) error {
	...
	_, err := wfClientset.nholuongutV1alpha1().WorkflowTemplates(metav1.NamespaceDefault).Create(ctx, wftmpl, metav1.CreateOptions{})
...
var invalidWfNoImage = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
var invalidWfNoImageScript = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  name: hello-world-right-env-12
spec:
...
func TestValidateStartedATVariable(t *testing.T) {
	wf := `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
...
var globalAnnotationsAndLabels = `apiVersion: nholuongut.io/v1alpha1
kind: Workflow
metadata:
  generateName: hello-world-
  labels:

...
func printCostOptimizationNudges(wfList []wfv1.Workflow, out io.Writer) {
	...
	if completed > 100 || incomplete > 100 {
		...
		_, _ = fmt.Fprintln(out, "Learn more at https://nholuongut.github.io/argo-workflows/cost-optimisation/")
	}
}
...
func PrintSecurityNudges(wf wfv1.Workflow, out io.Writer) {
	if wf.Spec.SecurityContext == nil {
		...
		_, _ = fmt.Fprintln(out, "Learn more at https://nholuongut.github.io/argo-workflows/workflow-pod-security-context/")
	}
}

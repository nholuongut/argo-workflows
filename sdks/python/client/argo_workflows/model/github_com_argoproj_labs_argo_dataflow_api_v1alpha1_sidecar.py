...
class GithubComnholuongutLabsArgoDataflowApiV1alpha1Sidecar(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComnholuongutLabsArgoDataflowApiV1alpha1Sidecar - a model defined in OpenAPI

...
func TestUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			data:            `{"user_tz":"America\/Chicago","sub":"test-user@nholuongut.github.io","user_locale":"en","idp_name":"UserNamePassword","user.tenant.name":"test-user","onBehalfOfUser":true,"idp_guid":"UserNamePassword","amr":["USERNAME_PASSWORD"],"iss":"https:\/\/identity-service.nholuongut.github.io","user_tenantname":"test-user","client_id":"tokenGenerator","user_isAdmin":true,"sub_type":"user","scope":"","client_tenantname":"argo-proj","region_name":"us1","user_lang":"en","userAppRoles":["Authenticated","Global Viewer","Identity Domain Administrator"],"exp":1626527469,"iat":1626467469,"client_guid":"adsf34534645654653454","client_name":"tokenGenerator","idp_type":"LOCAL","tenant":"test-user23523423","jti":"345sd435d454356","ad_groups":["argo_admin", "argo_readonly"],"gtp":"jwt","user_displayname":"Test User","sub_mappingattr":"userName","primTenant":true,"tok_type":"AT","ca_guid":"test-ca_guid","aud":["example-aud"],"user_id":"8948923893458945234","clientAppRoles":["Authenticated Client","Cross Tenant"],"tenant_iss":"https:\/\/identiy-service.nholuongut.github.io"}`,
			...
			expectedClaims: &Claims{
				Claims: jwt.Claims{
					...
					Issuer:    "https://identity-service.nholuongut.github.io",
					Subject:   "test-user@nholuongut.github.io",
					Expiry:    &testExpiry,
					NotBefore: nil,
				...
				RawClaim: map[string]interface{}{
					...
					"idp_type":          "LOCAL",
					"iss":               "https://identity-service.nholuongut.github.io",
					"jti":               "345sd435d454356",
					"onBehalfOfUser":    true,
					"primTenant":        true,
					"region_name":       "us1",
					"scope":             "",
					"sub":               "test-user@nholuongut.github.io",
					"sub_mappingattr":   "userName",
					"sub_type":          "user",
					"tenant":            "test-user23523423",
					"tenant_iss":        "https://identiy-service.nholuongut.github.io",
					"tok_type":          "AT",

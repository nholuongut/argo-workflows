  ...
  "workflow": {
	...
	s.Run("ListWFsGoodToken", func() {
		s.e().GET("/api/v1/workflows/"+nsName).
			WithQuery("listOptions.labelSelector", "workflows.nholuongut.io/test").
			Expect().
			Status(200).
			JSON().
			Path("$.items").
...
func (s *ArgoServerSuite) TestWorkflowService() {
  ...
  "workflow": {
    "metadata": {
      "generateName": "test-",
      "labels": {
         "workflows.nholuongut.io/test": "subject-1"
      }
    },
    "spec": {
      "templates": [
	...
	s.Run("List", func() {
		j := s.e().GET("/api/v1/workflows/argo").
			WithQuery("listOptions.labelSelector", "workflows.nholuongut.io/test=subject-1").
			Expect().
			Status(200).
			JSON()
		j.
...
func (s *ArgoServerSuite) TestCronWorkflowService() {
  ...
  "cronWorkflow": {
    "metadata": {
      "name": "test",
      "labels": {
        "workflows.nholuongut.io/test": "subject-2"
      }
    },
    "spec": {
      "schedule": "* * * * *",
	...
	s.Run("List", func() {
		...
		s.Given().
			CronWorkflow(`apiVersion: nholuongut.io/v1alpha1
kind: CronWorkflow
metadata:
...
`)
		...
		s.e().GET("/api/v1/cron-workflows/argo").
			WithQuery("listOptions.labelSelector", "workflows.nholuongut.io/test=subject-2").
			Expect().
			Status(200).
			JSON().
			Path("$.items").
    ...
    "spec": {
      "schedule": "1 * * * *",
      "workflowMetadata": {
        "labels": {"workflows.nholuongut.io/test": "true"}
      },
      "workflowSpec": {
        "entrypoint": "whalesay",
        "templates": [
	...
	for _, tt := range []struct {
		...
		s.Run(tt.name, func() {
			path := s.e().GET("/api/v1/archived-workflows").
				...
				WithQuery("listOptions.labelSelector", "workflows.nholuongut.io/test,"+tt.selector).
				Expect().
				Status(200).
				JSON().
				Path("$.items")
...
func (s *ArgoServerSuite) TestWorkflowTemplateService() {
  ...
  "template": {
    "metadata": {
      "name": "test",
      "labels": {
         "workflows.nholuongut.io/test": "subject-3"
      }
    },
    "spec": {
      "templates": [
	...
	s.Run("List", func() {
		...
		s.e().GET("/api/v1/workflow-templates/argo").
			WithQuery("listOptions.labelSelector", "workflows.nholuongut.io/test=subject-3").
			Expect().
			Status(200).
			JSON().
			Path("$.items").
...
func (s *ArgoServerSuite) TestSubmitWorkflowFromResource() {
  ...
  "template": {
    "metadata": {
      "name": "test",
      "labels": {
         "workflows.nholuongut.io/test": "subject-4"
      }
    },
    "spec": {
      "templates": [
  ...
  "cronWorkflow": {
    "metadata": {
      "name": "test",
      "labels": {
        "workflows.nholuongut.io/test": "subject-5"
      }
    },
    "spec": {
      "schedule": "* * * * *",
  ...
  "template": {
    "metadata": {
      "name": "test",
      "labels": {
         "workflows.nholuongut.io/test": "subject-6"
      }
    },
    "spec": {
      "templates": [

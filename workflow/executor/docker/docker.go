...
import (
	...
	"github.com/nholuongut/argo-workflows/v3/util/file"
...
// https://github.com/nholuongut/argo-workflows/issues/6352
...
func (d *DockerExecutor) validateCompleted(ctx context.Context, containerNames []string) (bool, error) {
	...
	for _, name := range containerNames {
		...
		if container.status == "Created" {
			...
			// docker inspect $(docker run -d --entrypoint invalid nholuongut/argosay:v2) | less

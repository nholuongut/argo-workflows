module github.com/nholuongut/argo-workflows/v3
...
require (
	...
	github.com/nholuongut-labs/argo-dataflow v0.0.107
	github.com/nholuongut/argo-events v1.5.0
	github.com/nholuongut/pkg v0.11.0

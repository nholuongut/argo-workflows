...
import (
	...
	"github.com/nholuongut/pkg/humanize"
	argokubeerr "github.com/nholuongut/pkg/kube/errors"
	...
	"github.com/nholuongut/argo-workflows/v3/pkg/client/clientset/versioned/typed/workflow/v1alpha1"
	"github.com/nholuongut/argo-workflows/v3/util"
	"github.com/nholuongut/argo-workflows/v3/util/diff"
	envutil "github.com/nholuongut/argo-workflows/v3/util/env"
	errorsutil "github.com/nholuongut/argo-workflows/v3/util/errors"
	"github.com/nholuongut/argo-workflows/v3/util/expr/env"
	"github.com/nholuongut/argo-workflows/v3/util/intstr"
	"github.com/nholuongut/argo-workflows/v3/util/resource"
	"github.com/nholuongut/argo-workflows/v3/util/retry"
	argoruntime "github.com/nholuongut/argo-workflows/v3/util/runtime"
	"github.com/nholuongut/argo-workflows/v3/util/slice"
	"github.com/nholuongut/argo-workflows/v3/util/template"
	waitutil "github.com/nholuongut/argo-workflows/v3/util/wait"
	"github.com/nholuongut/argo-workflows/v3/workflow/common"
	controllercache "github.com/nholuongut/argo-workflows/v3/workflow/controller/cache"
	"github.com/nholuongut/argo-workflows/v3/workflow/controller/estimation"
	"github.com/nholuongut/argo-workflows/v3/workflow/controller/indexes"
	"github.com/nholuongut/argo-workflows/v3/workflow/metrics"
	"github.com/nholuongut/argo-workflows/v3/workflow/progress"
	argosync "github.com/nholuongut/argo-workflows/v3/workflow/sync"
	"github.com/nholuongut/argo-workflows/v3/workflow/templateresolution"
	wfutil "github.com/nholuongut/argo-workflows/v3/workflow/util"
...
func (woc *wfOperationCtx) persistUpdates(ctx context.Context) {
	...
	wfClient := woc.controller.wfclientset.nholuongutV1alpha1().Workflows(woc.wf.ObjectMeta.Namespace)
...
// See https://github.com/nholuongut/argo-workflows/issues/913
...
func (woc *wfOperationCtx) reapplyUpdate(ctx context.Context, wfClient v1alpha1.WorkflowInterface, nodes wfv1.Nodes) (*wfv1.Workflow, error) {
	...
	for {
		...
		// https://github.com/nholuongut/argo-workflows/issues/4798
...
func (woc *wfOperationCtx) inferFailedReason(pod *apiv1.Pod) (wfv1.NodePhase, string) {
	...
	for _, ctr := range ctrs {
		...
		// https://github.com/nholuongut/argo-workflows/issues/3879
...
func (woc *wfOperationCtx) setExecWorkflow(ctx context.Context) error {
	...
	if woc.wf.Status.Phase == wfv1.WorkflowUnknown {
		...
		wftmplGetter := templateresolution.WrapWorkflowTemplateInterface(woc.controller.wfclientset.nholuongutV1alpha1().WorkflowTemplates(woc.wf.Namespace))
		cwftmplGetter := templateresolution.WrapClusterWorkflowTemplateInterface(woc.controller.wfclientset.nholuongutV1alpha1().ClusterWorkflowTemplates())
